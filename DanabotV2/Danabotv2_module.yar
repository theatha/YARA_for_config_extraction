...
rule danabot_config_extractor {
    ...
    condition:
        $s1 and console.hex("OFFSET: ",@s1+698) and
            console.log("C2-ip1: ",pestr.print_int_data(@s1+698,4)) and
            console.log("C2-ip2: ",pestr.print_int_data(@s1+706,4)) and
            console.log("C2-ip3: ",pestr.print_int_data(@s1+714,4)) and
            console.log("C2-ip4: ",pestr.print_int_data(@s1+722,4))
}
